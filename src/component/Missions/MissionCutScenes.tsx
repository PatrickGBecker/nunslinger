...
const MissionCutScenes = {
    ...
    mission3: [
        ...
        `Father Felix: Not long. We recieved the report while you were still underground. But his condition is... I'm sorry, Sister Beretta. It appears to be an Archdemon.`,
