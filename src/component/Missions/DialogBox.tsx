...
const messages =  {
    ...
    mission3: [
        ...
        `Father Felix: Blessed are the stinky for they shall inherit soap. Did it bother you, being in complete darkness for that long?`,
        ...
        `Sister Beretta: Man looks on the outward appearance, but the Lord looks on the heart.`,
